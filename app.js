...
const legalText = {
  ...
  terms: `
    ...
    <h4>1. The Service</h4>
    <p>Codecanic scans repositories and infrastructure you authorize, generates prioritized reports, and proposes repairs for your review. The web Service is open to every team at no cost and supported by sponsor advertising. The Codecanic iOS and macOS apps offer an optional auto-renewable subscription, <strong>Codecanic Pro</strong> — Monthly at $9.99/month or Annual at $79.99/year, each with a 3-day free trial for new subscribers; it is billed by Apple to your Apple Account, renews automatically unless cancelled at least 24 hours before the end of the current period, and can be managed or cancelled in your Apple Account settings. You retain ownership of your code, your provider accounts, and any data you submit.</p>
